...
export default async function EngineerIncidentModal({ params }: { params: Promise<{ id: string }> }) {
  ...
  return (
    <Modal>
      <div className="space-y-4">
        ...
        <a
          href={`/engineer/incidents/${incident.id}`}
          className="inline-block text-xs text-amber-500 hover:underline"
        >
