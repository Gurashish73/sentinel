...
export default async function CommanderTimelineSlot({ params }: { params: Promise<{ id: string }> }) {
  ...
  return <IncidentTimelinePanel incident={incident} orgId={orgId} role="COMMANDER" />;
}